...
<head>
    ...
    <meta content='Blog Sécurisé' property='og:site_name'/>
    ...
    <title>Blog Sécurisé | Plate-forme d'actualités sur la cybersécurité de confiance</title>
    <meta content='Blog Sécurisé | #1 Trusted Cybersecurity News Site' name='twitter:title' property='og:title'/>
    <meta content='Blog Sécurisé is the most trusted and popular cybersecurity publication for information security professionals seeking breaking news, actionable insights and analysis.' name='description'/>
    <meta content='Blog Sécurisé is the most trusted and popular cybersecurity publication for information security professionals seeking breaking news, actionable insights and analysis.' property='og:description'/>
    <meta content='Blog Sécurisé is the most trusted and popular cybersecurity publication for information security professionals seeking breaking news, actionable insights and analysis.' name='twitter:description'/>
    ...
    <link href="https://thehackernews.com/?m=1" media='only screen and (max-width: 640px)' rel='alternate'/>
    <meta content='https://thehackernews.com/' property='og:url'/>
    <meta content='@TheHackersNews' name='twitter:creator'/>
    <meta content='@TheHackersNews' name='twitter:site'/>
    <meta content='thehackernews.com' name='twitter:domain'/>
    <meta content='summary_large_image' name='twitter:card'/>
    <meta content='1251386282' property='fb:admins'/>
    <meta content='172819872731894' property='fb:pages'/>
    <link href='https://feeds.feedburner.com/TheHackersNews' rel='alternate' title='Blog Sécurisé RSS Feeds' type='application/rss+xml'/>
    <link href='https://thehackernews.com/feeds/posts/default' rel='alternate' title='Blog Sécurisé RSS Feeds' type='application/atom+xml'/>
    <meta content='cyber security news, cyber news, cyber security news today, cyber security updates, cyber updates, hacker news, hacking news, software vulnerability, cyber attacks, data breach, ransomware malware, how to hack, network security, information security, Blog Sécurisé, computer security' name='keywords'/>
    <style>
    </style>
    <style>
    ...
    *, ::before, ::after {
    ...
    .cf:after, .clear:after, .separator:after, .tr-caption-container:after {
        clear: both
    }

    .cf:after, .cf:before, .clear:after, .clear:before, .separator:after, .separator:before {
        display: block;
        font-size: 0;
        content: " ";
        clear: both;
    ...
    .articlebody a, a, a:active, a:focus, a:hover, a:visited {
    ...
    .tr-caption:not(:empty):before {
        display: inline-block;
        width: 30px;
        height: 5px;
        content: '';
        border-top: 1px solid #425a78;
        margin: 0 8px;
    }
    ...
    .separator a img, .tr-caption-container img {
        outline: 0;
        border: 0;
        border-radius: 0
    }

    .separator a img:active, .separator a img:focus, .separator a:active, .separator a:focus, .tr-caption-container img {
        outline: 0;
    ...
    .articlebody .tr-caption-container, .tr-caption-container td, .tr-caption-container th {
    ...
    .article-board {
        ...
        border-left: 6px solid #e6ecfe;
        border-right: 6px solid #e6ecfe;
        border-radius: 6px;
        font-size: 15.5px;
    }

    .grey-box {
        border: 2px dashed #f1f3ff;
        background: #f7f9ff;
        padding: 10px 20px;
        color: #425a78;
        border-radius: 5px;
    ...
    .article-btn {
        ...
        color: #fff;
        border-radius: 10px;
        border-bottom: 2px solid #09156b;
        border-right: 2px solid #09156b;
    ...
    .article-btn a, .article-btn a:hover, .article-btn a:link, .article-btn a:visited {
        color: #fff !important
    }
    ...
    .blog-pager-newer-link-mobile, .blog-pager-older-link-mobile {
    ...
    .blog-pager-newer-link-mobile:hover, .blog-pager-older-link-mobile:hover {
    ...
    .blog-pager-newer-link-mobile i {
        margin-right: 4px
    }

    .blog-pager-older-link-mobile i {
        margin-left: 4px
    }
    ...
    .body-post {
        margin-bottom: 25px;
        -webkit-box-shadow: 0 8px 0 0 #e2ebff;
        box-shadow: 0 8px 0 0 #dfe7ff;
        border-radius: 8px;
    }

    .story-link, .story-link:hover {
        text-decoration: none;
        display: block
    }

    .f-menu-list li a:hover, .story-link:hover .home-title {
        text-decoration: underline
    }

    .img-ratio {
        padding-bottom: 52.2875817%;
        position: relative;
        background: linear-gradient(rgb(242, 242, 242) 66%, rgba(242, 242, 242, 0))
    }
    ...
    .drop-menu, div.resize-and-crop img {
        position: absolute
    }

    .categ, .categ a:hover, .categ a:link, .categ a:visited, .categ h3, .tags {
    ...
    .header {
        background: #3732b3;
        width: 100%;
        background: rgb(39, 35, 151);
        background: -moz-linear-gradient(45deg, rgba(39, 35, 151, 1) 12%, rgba(55, 50, 179, 1) 31%, rgba(39, 35, 151, 1) 90%);
        background: -webkit-linear-gradient(45deg, rgba(39, 35, 151, 1) 12%, rgba(55, 50, 179, 1) 31%, rgba(39, 35, 151, 1) 90%);
        background: linear-gradient(45deg, rgba(39, 35, 151, 1) 12%, rgba(55, 50, 179, 1) 31%, rgba(39, 35, 151, 1) 90%);
        filter: progid: DXImageTransform.Microsoft.gradient(startColorstr="#272397", endColorstr="#272397", GradientType=1);
    }
    ...
    .right-box, .sharebelow-facebook, .sharebelow-comment {
        display: none
    }
    ...
    .pixpix img, .av-sidebar img {
        border-radius: 6px;
    }

    .pixpix:hover img, .av-sidebar:hover img {
        transform: scale(1.02);
    }
    ...
    .author, .author a, .author a:active, .author a:focus, .author a:hover {
        color: #425a78;
        margin-right: 15px
    }
    ...
    .sharebelow .sharebelow-facebook a {
        background: #3f51b5
    }

    .sharebelow .sharebelow-twitter a {
        background: #1da1f2
    }

    .sharebelow .sharebelow-linkedin a {
        background: #007bb6
    }
    ...
    .f-menu-cl-1, .f-menu-cl-2, .f-menu-cl-3, .f-menu-cl-4 {
        float: left;
        color: #555555
    }

    .f-menu-cl-1, .f-menu-cl-2 {
        width: 50%;
        display: block
    }
    ...
    .o-top cf {
        min-height: 50px;
        border-bottom: 1px solid #4868ad
    }
    ...
    .o-contact a:hover, .o-menu li a:hover {
        text-decoration: underline
    }
    ...
    .article-sources ol li, .article-sources ul li {
        margin: 0;
        padding: 0;
    }
    ...
    .google img, .zz-box-1 img, .ad_two img {
        border-radius: 6px
    }
    ...
    .header_unit, .header_big, .article_unit, .article_unit728, .article_unit300 {
        width: 300px;
        height: 250px;
        margin: 0 auto
    }
    ...
    .ad_two, .ad_three {
        padding: 15px 0;
        margin: 0;
        border-top: dashed 2px #d9deff;
        border-bottom: dashed 2px #d9deff
    }
    ...
    .timeline-title a:link, .timeline-title a:visited {
        color: #195afe;
        font-size: 18px;
        font-weight: 500;
    }
    ...
    @media only screen and (min-width: 600px) {
        ...
        .sharebelow-facebook, .sharebelow-comment {
            display: inline-block
        }
        ...
        .f-menu-cl-1, .f-menu-cl-2, .f-menu-cl-3 {
            width: 33.33%
        }
    ...
    @media only screen and (min-width: 768px) {
        ...
        .f-menu-cl-1, .f-menu-cl-2, .f-menu-cl-3, .f-menu-cl-4, .social-box {
            width: 33.33%
        }
    ...
    @media only screen and (min-width: 889px) {
        .latest, .latest:nth-child(2n + 0) {
            margin-right: 1.6%
        }

        .latest-desc, .right-box {
            display: block
        }
        ...
        .below-post-box, .deal-box, .main-box {
            max-width: 1110px
        }
    ...
    @media only screen and (min-width: 1150px) {
        ...
        .logo-area, .menu-more, .menu-ul li, .search-here {
            padding: 0 20px
        }
    ...
    @media only screen and (min-width: 1220px) {
        .float-share, .right-box {
            display: block
        }
    }
    </style>
    <style>
    .wn-button, .wn-button-2, .wn-label, .wn-label:after {
        display:inline-block
    }
    ...
    a.wn-head {
        color:#170d51 !important
    }

    a.wn-button:hover, a.wn-button-2:hover {
        box-shadow: 5px 5px 0 #f5e06c;
    }
    ...
    <script nonce="075cd31f-e9d4-4d63-ba42-ca937139c91e">
    try {
        (function(w, d) {
            !function(lD, lE, lF, lG) {
                ...
                for (const lJ of ["track", "set", "ecommerce", "debug"])
                ...
                lD.zaraz.init = () => {
                    ...
                    for (const lU of [localStorage, sessionStorage])
                        Object.keys(lU || {}).filter((lW => lW.startsWith("_zaraz_"))).forEach((lV => {
                            try {
...
<script type="cca6472cc74ef1f6ac653ea3-text/javascript" language="javascript">
...
<body>
    <header class='header clear'>
        <div class='top-bar cf'>
            <div class='top-bar-box cf'>
                <span class='slogan'>Plate-forme d'actualités sur la cybersécurité de confiance</span>
                <span class='top-follow'>
                    ...
                    <a class='top-follow-last' rel='noopener' target='_blank'>
        ...
        <div class='logo-area cf'>
            ...
            <div class='m-button m-menu-more'>
                <a aria-label='open menu' class='btn-open' href='javascript:void(0)'>
                    <i class='icon-font icon-menu m-m-icon'>&#61641;</i>
                </a>
            </div>
            <div class='m-search-here'>
    ...
    <nav class='menu cf' id='big-boss'>
        <div class='m-menu-box cf'>
            <ul class='cf m-menu-ul'>
                ...
                <li>
                    <a href='/p/upcoming-hacker-news-webinars.html' rel='noopener'>
        ...
        <div class='menu-box cf'>
            <ul class='cf menu-ul'>
                <li class='show-menu'>
                    <a itemprop='url'>Accueil</a>
                </li>
                <li class='eight_plus'>
                    <a href='/search/label/data%20breach'>Data Breaches</a>
                </li>
                <li class='show-menu'>
                    <a>Cybersécurité</a>
                </li>
                ...
                <li class='show-menu'>
                    <a href='https://deals.thehackernews.com/search?query=cybersecurity%2Bhacking%2BVPN%2Bsoftware' rel='noopener' target='_blank'>Store</a>
                </li>
                <li class='show-menu'>
                    <a>Contact</a>
                </li>
    ...
    <aside class='search-box cf'>
        <div class='search-b'>
            <form action='https://www.google.com/cse' id='searchform' method='get'>
        ...
        <div class='wrap cf'>
            <div class='o-top cf'>
                <a class='btn-close' href='javascript:void(0)'>
                    <i class='icon-font icon-cancel close-m-i'>&#59402;</i>
                </a>
            </div>
            <nav class='o-menu-box cf'>
                <div class='o-menu-left'>
                    <div class='o-menu-h5'>Ressources</div>
                    <ul class='o-menu'>
                        <li>
                            <a href='/p/upcoming-hacker-news-webinars.html' rel='noopener'>Webinars</a>
                        </li>
                        <li>
                            <a href='https://deals.thehackernews.com/search?query=cybersecurity%2Bhacking%2BVPN%2Bsoftware' rel='noopener' target='_blank'>THN Store</a>
                        </li>
                        <li>
                            <a href='https://thehackernews.tradepub.com' rel='noopener' target='_blank'>Free eBooks</a>
                        </li>
                    </ul>
                </div>
                <div class='o-menu-right'>
                    ...
                    <ul class='o-menu'>
                        <li>
                            <a href='/p/about-us.html'>About THN</a>
                        </li>
                        <li>
                            <a href='/p/careers-technical-writer-designer-and.html'>Jobs</a>
                        </li>
                        <li>
                            <a href='/p/advertising-with-hacker-news.html'>Advertise with us</a>
                        </li>
                    </ul>
                </div>
            </nav>
            ...
            <div class='o-follow cf'>
                <a href='https://www.facebook.com/thehackernews' rel='noopener' target='_blank'>
                    <i class='icon-font icon-facebook'>&#61594;</i>
                </a>
                <a href='https://twitter.com/thehackersnews' rel='noopener' target='_blank'>
                    <i class='icon-font icon-twitter'>&#61593;</i>
                </a>
                <a href='https://www.linkedin.com/company/thehackernews/' rel='noopener' target='_blank'>
                    <i class='icon-font icon-linkedin'>&#61665;</i>
                </a>
                <a href='https://www.youtube.com/c/thehackernews?sub_confirmation=1' rel='noopener' target='_blank'>
                    <i class='icon-font icon-youtube'>&#61799;</i>
                </a>
                <a href='https://www.instagram.com/thehackernews/' rel='noopener' target='_blank'>
                    <i class='icon-font icon-instagram'>&#61805;</i>
                </a>
            </div>
            <div class='o-sub cf'>
                <a href='https://feeds.feedburner.com/TheHackersNews' rel='noopener' target='_blank'>
                    <i class='icon-font icon-rss'>&#61598;</i>
                     RSS Feeds
                </a>
                <a href='#email-outer'>
                    <i class='icon-font icon-bell-alt'>&#61683;</i>
                     Email Alerts
                </a>
                <a href='https://t.me/+wKrQxniFO1Q1OTRk' rel='noopener' target='_blank'>
    ...
    <div class='pixpix cf'>
        <center class='cf'>
            <a rel='nofollow noopener' target='_blank' title='SaaS Security'>
                <img alt='SaaS Security' class='no-lazy' decoding='async' fetchpriority='high' height='300' importance='highest' src='https://www.bitsight.com/sites/default/files/migration/images/7%2520Cybersecurity%2520Frameworks%2520To%2520Reduce%2520Cyber%2520Risk_Banner_1.jpg' width="100%"/>
            </a>
        </center>
    </div>
    <main class='main clear'>
        <div class='main-box clear'>
            <h1 class='story-title-all'>Blog Sécurisé | Plate-forme d'actualités sur la cybersécurité de confiance</h1>
            <div class='main-left-right clear'>
                        ...
                        <div class='widget Blog' data-version='1' id='Blog1'>
                            <div class='blog-posts clear'>
                                <div class='body-post clear'>
                                    <a class='story-link' href="https://thehackernews.com/2024/03/us-charges-7-chinese-nationals-in-major.html">
                                        <div class='clear home-post-box cf'>
                                            <div class='home-img clear'>
                                                <div class='img-ratio'>
                                                    <img alt='U.S. Charges 7 Chinese Nationals in Major 14-Year Cyber Espionage Operation' class='home-img-src lazyload' data-src='https://www.bitsight.com/sites/default/files/migration/images/7%2520Cybersecurity%2520Frameworks%2520To%2520Reduce%2520Cyber%2520Risk_Banner_1.jpg' decoding='async' height='380' src='https://www.bitsight.com/sites/default/files/migration/images/7%2520Cybersecurity%2520Frameworks%2520To%2520Reduce%2520Cyber%2520Risk_Banner_1.jpg' width='728'/>
                                                </div>
                                                <noscript>
                                                    <img alt='U.S. Charges 7 Chinese Nationals in Major 14-Year Cyber Espionage Operation' decoding='async' loading='lazy' src='https://www.bitsight.com/sites/default/files/migration/images/7%2520Cybersecurity%2520Frameworks%2520To%2520Reduce%2520Cyber%2520Risk_Banner_1.jpg'/>
                                                </noscript>
                                            </div>
                                            <div class='clear home-right'>
                                                <h2 class='home-title'>U.S. Charges 7 Chinese Nationals in Major 14-Year Cyber Espionage Operation</h2>
                                ...
                                <div class='body-post clear'>
                                    <a class='story-link' href="https://thehackernews.com/2024/03/cisa-alerts-on-active-exploitation-of.html">
                                        <div class='clear home-post-box cf'>
                                            <div class='home-img clear'>
                                                <div class='img-ratio'>
                                                    <img alt='CISA Alerts on Active Exploitation of Flaws in Fortinet, Ivanti, and Nice Products' class='home-img-src lazyload' data-src='https://www.bitsight.com/sites/default/files/migration/images/7%2520Cybersecurity%2520Frameworks%2520To%2520Reduce%2520Cyber%2520Risk_Banner_1.jpg' decoding='async' height='380' src='https://www.bitsight.com/sites/default/files/migration/images/7%2520Cybersecurity%2520Frameworks%2520To%2520Reduce%2520Cyber%2520Risk_Banner_1.jpg' width='728'/>
                                                </div>
                                                <noscript>
                                                    <img alt='CISA Alerts on Active Exploitation of Flaws in Fortinet, Ivanti, and Nice Products' decoding='async' loading='lazy' src='https://www.bitsight.com/sites/default/files/migration/images/7%2520Cybersecurity%2520Frameworks%2520To%2520Reduce%2520Cyber%2520Risk_Banner_1.jpg'/>
                                                </noscript>
                                            </div>
                                            <div class='clear home-right'>
                                                <h2 class='home-title'>CISA Alerts on Active Exploitation of Flaws in Fortinet, Ivanti, and Nice Products</h2>
                                                <div class='item-label'>
                                                    <span class='h-datetime'>
                                                        <i class='icon-font icon-calendar'>&#59394;</i>
                                                        Mar 26, 2024
                                                    </span>
                                                    <span class='h-tags'>Cyber Attack / Vulnerability</span>
                                                </div>
                                                <div class='home-desc'> The U.S. Cybersecurity and Infrastructure Security Agency (CISA) on Monday&#160; placed &#160;three security flaws to its Known Exploited Vulnerabilities ( KEV ) catalog, citing evidence of active exploitation. The vulnerabilities added are as follows - CVE-2023-48788 &#160;(CVSS score: 9.3) - Fortinet FortiClient EMS SQL Injection Vulnerability CVE-2021-44529 &#160;(CVSS score: 9.8) - Ivanti Endpoint Manager Cloud Service Appliance (EPM CSA) Code Injection Vulnerability CVE-2019-7256 &#160;(CVSS score: 10.0) - Nice Linear eMerge E3-Series OS Command Injection Vulnerability The shortcoming impacting Fortinet FortiClient EMS&#160; came to light &#160;earlier this month, with the company describing it as a flaw that could allow an unauthenticated attacker to execute unauthorized code or commands via specifically crafted requests. Fortinet has since revised its advisory to confirm that it has been exploited in the wild, although no other details regarding the nature of the attacks are currently available. CVE-20</div>
                                            </div>
                                        </div>
                                    </a>
                                </div>
                                ...
                                <div class='body-post clear'>
                                    <a class='story-link' href='https://thehackernews.com/2024/03/crafting-and-communicating-your.html'>
                                        <div class='clear home-post-box cf'>
                                            <div class='home-img clear'>
                                                <div class='img-ratio'>
                                                    <img alt='Crafting and Communicating Your Cybersecurity Strategy for Board Buy-In' class='home-img-src lazyload' data-src='https://www.bitsight.com/sites/default/files/migration/images/7%2520Cybersecurity%2520Frameworks%2520To%2520Reduce%2520Cyber%2520Risk_Banner_1.jpg' decoding='async' height='380' src='https://www.bitsight.com/sites/default/files/migration/images/7%2520Cybersecurity%2520Frameworks%2520To%2520Reduce%2520Cyber%2520Risk_Banner_1.jpg' width='728'/>
                                                </div>
                                                <noscript>
                                                    <img alt='Crafting and Communicating Your Cybersecurity Strategy for Board Buy-In' decoding='async' loading='lazy' src='https://www.bitsight.com/sites/default/files/migration/images/7%2520Cybersecurity%2520Frameworks%2520To%2520Reduce%2520Cyber%2520Risk_Banner_1.jpg'/>
                                                </noscript>
                                            </div>
                                            <div class='clear home-right'>
                                                <h2 class='home-title'>Crafting and Communicating Your Cybersecurity Strategy for Board Buy-In</h2>
                                                <div class='item-label'>
                                                    <span class='h-datetime'>
                                                        <i class='icon-font icon-calendar'>&#59394;</i>
                                                        Mar 19, 2024
                                                    </span>
                                                    <span class='h-tags'>Regulatory Compliance / Cloud Security</span>
                                                </div>
                                                <div class='home-desc'> In an era where digital transformation drives business across sectors, cybersecurity has transcended its traditional operational role to become a cornerstone of corporate strategy and risk management. This evolution demands a shift in how cybersecurity leaders&#8212;particularly Chief Information Security Officers (CISOs)&#8212;articulate the value and urgency of cybersecurity investments to their boards.&#160; The Strategic Importance of Cybersecurity Cybersecurity is no longer a backroom IT concern but a pivotal agenda item in boardroom discussions. The surge in cyber threats, coupled with their capacity to disrupt business operations, erode customer trust, and incur significant financial losses, underscores the strategic value of robust cybersecurity measures. Moreover, as companies increasingly integrate digital technologies into their core operations, the significance of cybersecurity in safeguarding corporate assets and reputation continues to rise. The Current State of Cybersecurity in Corpo</div>
                                            </div>
                                        </div>
                                    </a>
                                </div>
                                <div class='body-post clear'>
                                    <a class='story-link' href="https://thehackernews.com/2024/03/new-gofetch-vulnerability-in-apple-m.html">
                                        <div class='clear home-post-box cf'>
                                            <div class='home-img clear'>
                                                <div class='img-ratio'>
                                                    <img alt='New "GoFetch" Vulnerability in Apple M-Series Chips Leaks Secret Encryption Keys' class='home-img-src lazyload' data-src='https://www.bitsight.com/sites/default/files/migration/images/7%2520Cybersecurity%2520Frameworks%2520To%2520Reduce%2520Cyber%2520Risk_Banner_1.jpgg' decoding='async' height='380' src='https://www.bitsight.com/sites/default/files/migration/images/7%2520Cybersecurity%2520Frameworks%2520To%2520Reduce%2520Cyber%2520Risk_Banner_1.jpg' width='728'/>
                                                </div>
                                                <noscript>
                                                    <img alt='New "GoFetch" Vulnerability in Apple M-Series Chips Leaks Secret Encryption Keys' decoding='async' loading='lazy' src='https://www.bitsight.com/sites/default/files/migration/images/7%2520Cybersecurity%2520Frameworks%2520To%2520Reduce%2520Cyber%2520Risk_Banner_1.jpg'/>
                                                </noscript>
                                            </div>
                                            <div class='clear home-right'>
                                                <h2 class='home-title'>New "GoFetch" Vulnerability in Apple M-Series Chips Leaks Secret Encryption Keys</h2>
                                                <div class='item-label'>
                                                    <span class='h-datetime'>
                                                        <i class='icon-font icon-calendar'>&#59394;</i>
                                                        Mar 25, 2024
                                                    </span>
                                                    <span class='h-tags'>Hardware Security / Data Protection</span>
                                                </div>
                                                <div class='home-desc'> A new security shortcoming discovered in Apple M-series chips could be exploited to extract secret keys used during cryptographic operations. Dubbed&#160; GoFetch , the vulnerability relates to a microarchitectural side-channel attack that takes advantage of a feature known as data memory-dependent prefetcher (DMP) to target constant-time cryptographic implementations and capture sensitive data from the CPU cache. Apple was made aware of the findings in December 2023. Prefetchers are a hardware optimization technique that predicts what memory addresses a currently running program will access in the near future and retrieve the data into the cache accordingly from the main memory. The goal of this approach is to reduce the program&#39;s memory access latency. DMP is a type of prefetcher that takes into account the contents of memory based on previously observed access patterns when determining what to prefetch. This behavior makes it ripe for cache-based attacks that trick the prefetche</div>
                                            </div>
                                        </div>
                                    </a>
                                </div>
                ...
                <aside class='right-box' id='right-box'>
                    ...
                    .custom-text {
                        ...
                        transition: background-color 0.3s ease, margin-top 0.3s ease, border 0.3s ease;
                        border-top: 4px solid #dce2fa;
                        letter-spacing: -0.1px;
                    }
                    ...
                    .custom-link:hover .inner-content {
                        max-height: 100%;
                    }

                    .custom-link:hover .highlight-header {
                        background: none;
                        position: static;
                        overflow: visible;
                        height: auto;
                    ...
                    .custom-link:hover .highlight-header:after {
                        background: none;
                        position: static;
                        overflow: visible;
                        height: auto;
                    ...
                    .custom-link:not(:hover) .inner-content {
                        max-height: 0;
                        transition: none;
                    }
                    ...
                    <div class='clear cf box-side okaybob' id='expanding'>
                        <a class='custom-link' href='https://thehackernews.uk/atlassian-eol-rewind' rel='nofollow noopener' target='_blank'>
                            <div class='custom-container'>
                                <div>
                                    <img alt='Browser Security' class='custom-image lazyload' data-src='https://www.bitsight.com/sites/default/files/migration/images/7%2520Cybersecurity%2520Frameworks%2520To%2520Reduce%2520Cyber%2520Risk_Banner_1.jpg' src='https://www.bitsight.com/sites/default/files/migration/images/7%2520Cybersecurity%2520Frameworks%2520To%2520Reduce%2520Cyber%2520Risk_Banner_1.jpg'/>
                                </div>
                                <div class='custom-text'>
                                    <p>Goodbye, Atlassian Server. Goodbye&#8230; Backups?</p>
                                    <p class='highlight-header cf'>Protect your data on Atlassian Cloud from disaster with Rewind's daily backups and on-demand restores.</p>
                                    <div class='inner-content cf'>
                                        <div class='buttonss cf'>Get Cloud Backups</div>
                                    </div>
                                </div>
                            </div>
                        </a>
                        ...
                        <div class='widget PopularPosts' data-version='1' id='PopularPosts1'>
                            ...
                            <div class='widget-content popular-posts' id='popular-list'>
                                <div class='cf pop-article clear'>
                                    <a class='pop-link cf' href="https://thehackernews.com/2024/03/making-sense-of-operational-technology.html">
                                        <div class='side-pop-image'>
                                            <figure class='pop-image'>
                                                <img alt='Making Sense of Operational Technology Attacks: The Past, Present, and Future' border='0' class='lazyload' data-src='https://www.bitsight.com/sites/default/files/migration/images/7%2520Cybersecurity%2520Frameworks%2520To%2520Reduce%2520Cyber%2520Risk_Banner_1.jpg' decoding='async' height='72' src='https://www.bitsight.com/sites/default/files/migration/images/7%2520Cybersecurity%2520Frameworks%2520To%2520Reduce%2520Cyber%2520Risk_Banner_1.jpg'/>
                                            </figure>
                                        </div>
                                        
                                        <div class='pop-desc'>
                                            <div class='pop-title'>CTEM 101 - Go Beyond Vulnerability Management with Continuous Threat Exposure Management</div>
                                        </div>
                                    </a>
                                </div>
                                <div class='cf pop-article clear last-three'>
                                    <a class='pop-link cf' href="https://thehackernews.com/2023/06/critical-security-flaw-in-social-login.html">
                                        <div class='side-pop-image'>
                                            <figure class='pop-image'>
                                                <img alt='Critical Security Flaw in Social Login Plugin for WordPress Exposes Users&#39; Accounts' border='0' class='lazyload' data-src='https://www.bitsight.com/sites/default/files/migration/images/7%2520Cybersecurity%2520Frameworks%2520To%2520Reduce%2520Cyber%2520Risk_Banner_1.jpg' decoding='async' height='72' src='https://www.bitsight.com/sites/default/files/migration/images/7%2520Cybersecurity%2520Frameworks%2520To%2520Reduce%2520Cyber%2520Risk_Banner_1.jpg'/>
                                            </figure>
                                        </div>
                                        
                                        <div class='pop-desc'>
                                            <div class='pop-title'>Key Lesson from Microsoft's Password Spray Hack: Secure Every Account </div>
                                        </div>
                                    </a>
                                </div>
                            </div>
                    ...
                    <section class='clear section okaybob side_res'>
                        <div class='PopularPosts'>
                            <div class='latest-title cf'>Popular Resources</div>
                            <div class='widget-content popular-posts' id='sidebar-list'>
                                <div class='cf pop-article clear'>
                                    <a class='pop-link cf' href='https://thehackernews.uk/ssh-passwordless' rel='' target='_blank'>
                                        <div class='side-pop-image'>
                                            <figure class='pop-image'>
                                                <img alt='Articles' border='0' class='lazyload' data-src='https://www.bitsight.com/sites/default/files/migration/images/7%2520Cybersecurity%2520Frameworks%2520To%2520Reduce%2520Cyber%2520Risk_Banner_1.jpg' decoding='async' height='72' src='https://www.bitsight.com/sites/default/files/migration/images/7%2520Cybersecurity%2520Frameworks%2520To%2520Reduce%2520Cyber%2520Risk_Banner_1.jpg'/>
                                            </figure>
                                        </div>
                                        <div class='pop-desc'>
                                            <div class='pop-title'>Get Latest Guide to Passwordless & Keyless Techniques for Modern Organizations</div>
                                        </div>
                                    </a>
                                </div>
                                <div class='cf pop-article clear'>
                                    <a class='pop-link cf' href='https://thehackernews.uk/material-google-drive-protection' rel='' target='_blank'>
                                        <div class='side-pop-image'>
                                            <figure class='pop-image'>
                                                <img alt='Articles' border='0' class='lazyload' data-src='https://www.bitsight.com/sites/default/files/migration/images/7%2520Cybersecurity%2520Frameworks%2520To%2520Reduce%2520Cyber%2520Risk_Banner_1.jpg' decoding='async' height='72' src='https://www.bitsight.com/sites/default/files/migration/images/7%2520Cybersecurity%2520Frameworks%2520To%2520Reduce%2520Cyber%2520Risk_Banner_1.jpg'/>
                                            </figure>
                                        ...
                                        <div class='pop-desc'>
                                            <div class='pop-title'>Expert Webinar: Learn Expert Strategies for Application Security</div>
                                        </div>
                                    </a>
                                </div>
                            </div>
    ...
    <section class='below-post okaybob cf'>
        <div class='below-post-box cf'>
            <div class='latest-title cf'>Ressources sur la cybersécurité</div>
            <div id='load-latest-2'>
                <article class='latest cf'>
                    <a class='latest-link' href='https://thehackernews.uk/AmjqwW' rel='' target='_blank'>
                        <div>
                            <img alt='Cybersecurity' class='lazyload' data-src='https://www.bitsight.com/sites/default/files/migration/images/7%2520Cybersecurity%2520Frameworks%2520To%2520Reduce%2520Cyber%2520Risk_Banner_1.jpg' decoding='async' src='https://www.bitsight.com/sites/default/files/migration/images/7%2520Cybersecurity%2520Frameworks%2520To%2520Reduce%2520Cyber%2520Risk_Banner_1.jpg'/>
                        </div>
                        <div>
                            <div class='latest-h3'>Discover How to Leverage AI to Prevent Cyber Risks</div>
                        </div>
                        <div class='latest-desc'>Our guide helps you understand AI security misconceptions, risk assessment strategies for AI features, third-party security, and AI governance.</div>
                    </a>
                </article>
                <article class='latest cf'>
                    <a class='latest-link' href='https://thehackernews.uk/passwordless-keyless' rel='' target='_blank'>
                        <div>
                            <img alt='Cybersecurity' class='lazyload' data-src='https://www.bitsight.com/sites/default/files/migration/images/7%2520Cybersecurity%2520Frameworks%2520To%2520Reduce%2520Cyber%2520Risk_Banner_1.jpg' decoding='async' src='https://www.bitsight.com/sites/default/files/migration/images/7%2520Cybersecurity%2520Frameworks%2520To%2520Reduce%2520Cyber%2520Risk_Banner_1.jpg'/>
                        </div>
                        <div>
                            <div class='latest-h3'>Enter the Passwordless & Keyless Future of Access Management</div>
                        </div>
                        <div class='latest-desc'>Reduce risks, costs & complexity of passwords and keys. Learn how to become credential-less in this whitepaper.</div>
                    </a>
                </article>
                <article class='latest cf'>
                    <a class='latest-link' href='https://thehackernews.uk/aws-security-best-practices' rel='' target='_blank'>
                        <div>
                            <img alt='Cybersecurity' class='lazyload' data-src='https://www.bitsight.com/sites/default/files/migration/images/7%2520Cybersecurity%2520Frameworks%2520To%2520Reduce%2520Cyber%2520Risk_Banner_1.jpg' decoding='async' src='https://www.bitsight.com/sites/default/files/migration/images/7%2520Cybersecurity%2520Frameworks%2520To%2520Reduce%2520Cyber%2520Risk_Banner_1.jpg'/>
                        </div>
                        <div>
                            <div class='latest-h3'>AWS Security Best Practices</div>
                        </div>
                        <div class='latest-desc'>Improve your security posture across your AWS footprint with this checklist.</div>
                    </a>
                </article>
                <article class='latest cf not-shuffle'>
                    <a class='latest-link' href='https://thehackernews.uk/georgetown-geopolitics' target='_blank'>
                        <div>
                            <img alt='Cybersecurity with Georgetown' class='lazyload' data-src='https://www.bitsight.com/sites/default/files/migration/images/7%2520Cybersecurity%2520Frameworks%2520To%2520Reduce%2520Cyber%2520Risk_Banner_1.jpg' decoding='async' src='https://www.bitsight.com/sites/default/files/migration/images/7%2520Cybersecurity%2520Frameworks%2520To%2520Reduce%2520Cyber%2520Risk_Banner_1.jpg'/>
                        </div>
                        <div>
                            <div class='latest-h3'>Georgetown University Seminar Series: Drivers of Geopolitical Insecurity</div>
                        </div>
                        <div class='latest-desc'>Hear insights from global experts on the factors that shape the world's political landscape.</div>
                    </a>
                </article>
            </div>
        </div>
        ...
        <div class='email-box-margin'>
            <div class='email-box'>
                <form action='https://inl02.netline.com/rssnews0001/' class='clear cf' id='subform' method='post' name='f1' target='_blank'>
                    <div class='email-box-h3'>Rejoignez nous !</div>
                    <p>Inscrivez-vous gratuitement et commencez à recevoir votre dose quotidienne d'informations, d'idées et de conseils sur la cybersécurité pour vous protégez !</p>
                    <div class='email-input'>
                        ...
                        <input class='text' id='input-email' name='email' placeholder='Entrer votre adresse e-mail ici..' required='' type='email'/>
    ...
    <footer class='footer cf'>
        <div class='footer-box clear'>
            <div class='footer-stuff clear cf'>
                <div class='footer-box-h4' id='follow-us'>Connectez avec nous!</div>
                <div class='follow-box cf'>
                    <div class='social-box s-tw'>
                        <a aria-label='twitter' rel='noopener' target='_blank'>
                            <i class='icon-font icon-twitter'>&#61593;</i>
                        </a>
                    </div>
                    <div class='social-box s-in'>
                        <a aria-label='linkedin' rel='noopener' target='_blank'>
                            <i class='icon-font icon-linkedin'>&#61665;</i>
                        </a>
                    </div>
                    ...
                    <div class='social-box s-tel'>
                        <a aria-label='telegram' rel='noopener' target='_blank'>
                            <i class='icon-font icon-telegram'>&#62150;</i>
                        </a>
                    </div>
                </div>
                <nav class='f-menu-box cf'>
                    <div class='f-menu-cl-1 cf'>
                        <div class='footer-box-h5'>Société</div>
                    ...
                    <div class='f-menu-cl-3 cf'>
                        <div class='footer-box-h5'>Accords</div>
                        <ul class='cf f-menu-list cf'>
                            <li>
                                <a>Piratage</a>
                            </li>
                    ...
                    <div class='f-menu-cl-4 cf'>
                        <a class='f-m-b' rel='noopener' target='_blank'>
                            <div class='f-menu-bt f-rss'>
                                <i class='icon-font icon-rss'>&#61598;</i>
                                 Flux RSS
                            </div>
                        </a>
                        <a class='f-m-b'>
                            <div class='f-menu-bt'>
                                <i class='icon-font icon-mail-alt'>&#61664;</i>
                                 blogsecurise@gmail.com
                            </div>
                        </a>
                    </div>
                </nav>
                <div class='footer-note cf'>&#169; Blog Sécurisé, 2024. Tous droits réservés.</div>
            </div>
        </div>
    </footer>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ["load-latest-2", "sidebar-list", "expanding"].forEach(t => {
            t = document.getElementById(t);
            t && function(n) {
                let e = [],
                    o = [];
                Array.from(n.children).forEach(t => {
                    (t.classList.contains("not-shuffle") ? o : e).push(t)
                });
                ...
                n.innerHTML = "",
                e.concat(o).forEach(t => n.appendChild(t))
            }(t)
        })
    });
    //]]>
    </script>
    <script async='async' defer='defer' type="cca6472cc74ef1f6ac653ea3-text/javascript">
    //<![CDATA[
    function loadScriptAsync(e) {
        const n = document.createElement("script");
        n.src = e,
        n.async = !0,
        document.body.appendChild(n)
    }
    function runAfterPageLoad(e) {
    ...
    runAfterPageLoad(function() {
        ...
        let t = e.length,
            n;
        function r(e) {
            e.dataset.src && (e.src = e.dataset.src, e.removeAttribute("data-src"), t--, n && n.unobserve(e), 0 !== t || n || (window.removeEventListener("scroll", i), window.removeEventListener("resize", i)))
        }
        const i = function(t, n) {
            ...
            e.forEach(function(e) {
                var t;
                0 <= (t = (t = e).getBoundingClientRect()).top && 0 <= t.left && t.bottom <= (window.innerHeight || document.documentElement.clientHeight) && t.right <= (window.innerWidth || document.documentElement.clientWidth) && r(e)
            })
        }, 200);
        "IntersectionObserver" in window ? (n = new IntersectionObserver(function(e) {
            e.forEach(function(e) {
                e.isIntersecting && r(e.target)
            })
        }, {
            rootMargin: "300px"
        }), e.forEach(function(e) {
    ...
    //<![CDATA[
    runAfterPageLoad(function() {
        for (var e = document.querySelector(".overlay"), o = document.querySelector(".button a"), t = document.querySelector(".share-modal"), l = document.querySelector(".search-box"), n = document.querySelectorAll(".menu-more, .m-menu-more"), c = 0; c < n.length; c++)
            n[c].addEventListener("click", function() {
                e.style.display = "block",
                o.classList.toggle("btn-open"),
                o.classList.toggle("btn-close"),
                document.documentElement.style.overflow = "hidden",
                document.body.style.overflow = "hidden"
            });
        for (var s = document.querySelectorAll(".btn-close"), c = 0; c < s.length; c++)
        ...
        for (var r = document.querySelectorAll(".share-show-modal, .fs-more"), c = 0; c < r.length; c++)
            r[c].addEventListener("click", function() {
                t.style.display = "block",
                document.documentElement.style.overflow = "hidden",
                document.body.style.overflow = "hidden"
            });
        for (var d = document.querySelectorAll(".share-close-modal"), c = 0; c < d.length; c++)
            d[c].addEventListener("click", function() {
                t.style.display = "none",
                document.documentElement.style.overflow = "auto",
                document.body.style.overflow = "auto"
            });
        for (var a = document.querySelectorAll(".search-here, .m-search-here"), c = 0; c < a.length; c++)
            a[c].addEventListener("click", function() {
                var e = this.querySelector("i"),
                    o = window.getComputedStyle(l).getPropertyValue("display");
                e.classList.contains("icon-search") ? (e.classList.remove("icon-search"), e.classList.add("fa-times")) : (e.classList.remove("fa-times"), e.classList.add("icon-search")),
                l.style.display = "none" === o ? "block" : "none",
    ...
    {"@context":"https://schema.org","@type":"Organization","name":"Blog Sécurisé","url":"https://thehackernews.com/","foundingDate":"2010","logo":"https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjucioIaLjDLMVbAzsIDpaYM754ZmWwLu6oPFfZ95bcJQK9paBjdrkpQnnjTExUWJbExlV10x25riYersOaWF_TFGCFvlw52qXMvrNMGacAb6nkP1RBTMGL1yWdvoajXbj5qf4U9O_sH6tH-BxNpOveZnxMT6bVDX57FaKB1jFlbPExVQgmA4HKKuROJA/s1700/THN.jpg","publisher":{"@type":"Organization","name":"Blog Sécurisé","url":"https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjucioIaLjDLMVbAzsIDpaYM754ZmWwLu6oPFfZ95bcJQK9paBjdrkpQnnjTExUWJbExlV10x25riYersOaWF_TFGCFvlw52qXMvrNMGacAb6nkP1RBTMGL1yWdvoajXbj5qf4U9O_sH6tH-BxNpOveZnxMT6bVDX57FaKB1jFlbPExVQgmA4HKKuROJA/s1700/THN.jpg","description":"Blog Sécurisé is the most trusted and popular cybersecurity publication for information security professionals seeking breaking news, actionable insights and analysis."},"sameAs":["https://twitter.com/thehackersnews","https://www.facebook.com/thehackernews","https://www.linkedin.com/company/thehackernews/","https://www.instagram.com/thehackernews/"],"potentialAction":{"@type":"SearchAction","target":"https://thehackernews.com/search?q={search_term_string}","query-input":"required name=search_term_string"},"contactPoint":[{"@type":"ContactPoint","telephone":"+1-123-456-7890","email":"admin@thehackernews.com","contactType":"Site Admin"}],"address":{"@type":"PostalAddress","streetAddress":"8913 Oak Valley Ave.","addressLocality":"New York City","addressRegion":"New York","postalCode":"10469"}}
    </script>
    <script data-cfasync='false'>
    //<![CDATA[
    document.addEventListener("DOMContentLoaded", function() {
        !function(e) {
            const t = document.querySelector(".blog-posts");
            var n = t.querySelector(".okaybob"),
                o = t.querySelectorAll(".body-post:not(.okaybob)");
            if (n && o.length >= e) {
                const r = n.parentNode;
                r.insertBefore(n, o[e - 2].nextSibling)
            }
        }(Math.random() < .8 ? Math.random() < .5 ? 2 : 3 : 4)
    });
    //]]>
    </script>
    <script async='async' type="cca6472cc74ef1f6ac653ea3-text/javascript">
    //<![CDATA[
    "serviceWorker" in navigator && window.addEventListener("load", () => {
        navigator.serviceWorker.register("/sw.js").then(e => {}).catch(e => {
            console.log("SW registration failed: ", e)
        })
    });
    //]]>
    </script>
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-7983783048239650" crossorigin="anonymous"></script>
    <tree></tree>
    <script src="/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="cca6472cc74ef1f6ac653ea3-|49" defer></script>
</body>
</html>
